...
const TERM_BATCHES: Record<number, string[]> = {
  0:  ['software engineer', 'data engineer', 'devops engineer', 'cloud engineer', 'platform engineer'],
  1:  ['staff nurse', 'registered nurse', 'band 5 nurse', 'community nurse', 'mental health nurse'],
  2:  ['accountant', 'finance manager', 'financial controller', 'management accountant', 'financial analyst'],
  3:  ['teacher', 'headteacher', 'senco', 'lecturer', 'teaching assistant'],
  4:  ['mechanical engineer', 'electrical engineer', 'civil engineer', 'structural engineer', 'aerospace engineer'],
  5:  ['product manager', 'project manager', 'programme manager', 'scrum master', 'delivery manager'],
  6:  ['doctor', 'gp', 'consultant physician', 'foundation doctor', 'clinical fellow'],
  7:  ['architect', 'quantity surveyor', 'structural engineer', 'building surveyor', 'planning officer'],
  8:  ['data scientist', 'machine learning engineer', 'ai engineer', 'nlp engineer', 'data architect'],
  9:  ['social worker', 'care manager', 'support worker', 'family support worker', 'youth worker'],
  10: ['marketing manager', 'digital marketing', 'seo manager', 'content manager', 'brand manager'],
  11: ['solicitor', 'barrister', 'legal counsel', 'paralegal', 'conveyancer'],
  12: ['pharmacist', 'clinical pharmacist', 'pharmacy manager', 'dispensary technician', 'medicines optimisation'],
  13: ['head chef', 'sous chef', 'kitchen manager', 'catering manager', 'executive chef'],
  14: ['cyber security', 'information security', 'penetration tester', 'security analyst', 'soc analyst'],
  15: ['hr manager', 'talent acquisition', 'people partner', 'hr business partner', 'recruitment manager'],
  16: ['radiographer', 'sonographer', 'imaging specialist', 'radiologist', 'nuclear medicine'],
  17: ['supply chain manager', 'logistics manager', 'procurement manager', 'warehouse manager', 'operations manager'],
  18: ['business analyst', 'systems analyst', 'it consultant', 'it manager', 'service desk manager'],
  19: ['physiotherapist', 'occupational therapist', 'speech therapist', 'podiatrist', 'dietitian'],
  20: ['dentist', 'dental surgeon', 'dental nurse', 'orthodontist', 'dental therapist'],
  21: ['ux designer', 'ui designer', 'product designer', 'graphic designer', 'creative director'],
  22: ['frontend developer', 'backend developer', 'full stack developer', 'python developer', 'java developer'],
  23: ['construction manager', 'site manager', 'bim manager', 'fit out manager', 'facilities manager'],
};
